...
<Modal close={() => {}} class="w-[calc(100vw*0.5)]">
	<Flex class="w-full items-start">
		...
		<Flex class="flex-col items-start gap-4">
			...
			<p>
				This is an extremely early build. There will be problems – edges are rough –
				features are lacking – we know 🙂 Let us know what you're running into and what
				you'd like to see.
			</p>
			<button
				onclick={() => accept()}
